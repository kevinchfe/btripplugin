...
public class BillSettlement<T> {
     ...
     * 企业ID
     */
    @TableField(fieldName = "企业 ID", description = "企业 ID")
     ...
     * 总数量
     */
    @TableField(fieldName = "总数量", description = "总数量")
     ...
     * 记账数据查询起始时间。
     */
    @TableField(fieldName = "记账数据查询起始时间", description = "记账数据查询起始时间")
     ...
     * 记账查询截止时间
     */
    @TableField(fieldName = "记账查询截止时间", description = "记账查询截止时间")
     ...
     */
    @TableField(fieldName = "数据所属类目", description = "数据所属类目")
    private Integer category;

    /**
     * 数据列表
     */
    @TableField(fieldName = "数据列表", description = "数据列表")
