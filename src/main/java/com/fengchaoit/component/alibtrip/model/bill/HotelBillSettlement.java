...
public class HotelBillSettlement extends SettlementRecord {
    /**
     * 入住时间
     */
    @JsonProperty("check_in_date")
    @TableField(fieldName = "入住时间", description = "入住时间", order = 4, fieldType = 5)
    ...
    @TableField(fieldName = "离店时间", description = "离店时间", order = 5, fieldType = 5)
